...
public class LocnBP implements
...
//
    private static boolean servicesConnected() {							    // Check that Google Play services is available
    ...
    public static void showLocationMarkers() {
    ...
    @Override public void onConnected(Bundle dataBundle) {								// Called by Location Services when the request to connect the client finishes successfully.
        ...
        Toast.makeText(c, "Connected", Toast.LENGTH_SHORT).show();			// Display the connection status
